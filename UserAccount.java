package com.example.kudu_card_credit_tracker;
...
public class UserAccount {
    String[] userDetails;
    Context context;
    String serverAddress = "http://lamp.ms.wits.ac.za/~s1876473/.../login.php";
    ...
    public void register(String[] new_userDetails)
    {
        ...
        @SuppressLint("StaticFieldLeak") AsyncHttpPost asyncHttpPost = new AsyncHttpPost(serverAddress, params) {
            @Override
            protected void onPostExecute(String output) {
                Toast.makeText(context, "You have been registered", Toast.LENGTH_SHORT);
            }
        };
        asyncHttpPost.execute();
    }
